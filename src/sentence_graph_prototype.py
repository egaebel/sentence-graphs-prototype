...
def reduce_sentence_graphs(sentence_graphs):
    sentence_graph_words = set(
        get_word_pos_tuples_from_sentence_graph(sentence_graphs[0]))
    for sentence_graph in sentence_graphs:
        sentence_graph_words.intersection(
            get_word_pos_tuples_from_sentence_graph(sentence_graph))
...
def get_word_pos_tuples_from_sentence_graph(sentence_graph):
    return [(sentence_graph.vertex_properties["word"][x], 
        sentence_graph.vertex_properties["part_of_speech"][x])
